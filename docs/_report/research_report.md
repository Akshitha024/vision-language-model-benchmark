---
title: "vision-language-model-benchmark: Multi-provider Vision-Language Model evaluation across DocVQA, ChartQA, MMMU"
...
Multi-provider Vision-Language Model evaluation across DocVQA, ChartQA, MMMU

This report presents the methodology, dataset, evaluation results, and analysis
of the vision-language-model-benchmark project. We describe the design choices, baseline
...
Multi-provider Vision-Language Model evaluation across DocVQA, ChartQA, MMMU The remainder of this section motivates the choice of approach.
